...
//The method needs to return a value of type int that represents the number of buckets that Bob needs to buy before going to
// work. To calculate the bucket count, refer to the notes below.
